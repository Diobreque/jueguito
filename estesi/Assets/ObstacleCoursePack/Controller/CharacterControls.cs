...
// Verificamos si llegamos a la meta
	...
	{
		// Detectamos si el player se encuentra en la meta
		if(objeto.gameObject.CompareTag("TagMeta"))
		{
			audioMeta.Play();
			audioBack.Stop();
			Debug.Log("Hemo llegao");
			// distToGround: modificar interfaz y mostrar informacion en pantalla
			// deshabilitar el avance del personaje
			// modificar la economia del player (aumentando monedas de oro)
		}
	}
